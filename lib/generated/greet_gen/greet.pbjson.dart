...
const $core.Map<$core.String, $core.dynamic> GreeterServiceBase$json = const {
  '1': 'Greeter',
  '2': const [
    const {'1': 'SayHello', '2': '.greet.HelloRequest', '3': '.greet.HelloReply'},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> GreeterServiceBase$messageJson = const {
  '.greet.HelloRequest': HelloRequest$json,
  '.greet.HelloReply': HelloReply$json,
};

/// Descriptor for `Greeter`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List greeterServiceDescriptor = $convert.base64Decode('CgdHcmVldGVyEjIKCFNheUhlbGxvEhMuZ3JlZXQuSGVsbG9SZXF1ZXN0GhEuZ3JlZXQuSGVsbG9SZXBseQ==');
